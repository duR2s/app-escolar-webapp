...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      // Rutas de Registro Interno (Dashboard)
      // Usamos la nueva pantalla que recibe el rol como parámetro obligatorio
      { path: 'registro/:rol', component: RegistroScreenComponent },
      { path: 'registro/:rol/:id', component: RegistroScreenComponent },
    ]
  },
  // fallback route
